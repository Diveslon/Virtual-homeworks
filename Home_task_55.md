...
### Ответ
<p align="center">
  <img width="903" height="249" src="Picture_55_4.PNG">
</p>
После перезапуска кластера Docker мы вступим во владение ключами взаимного шифрования TLS и будет требоваться ручная разблокировка менеджеров кластера, т.е. включится автоматическая блокировка. Это сделано для защиты шифрованных журналов RAFT нашего кластера. Так же при добавлении нового узла будет требоваться разблокировка кластера, поскольку ключ распостраняется на него апо взаимному TLS.
